...
This thesis presents a comprehensive study of multi-agent reinforcement learning using Spiking Neural Networks (SNN)s for decentralized control in edge computing environments. Chapter 1 introduces the motivation and provides a literature review, highlighting the need for biologically inspired neural models to achieve robust and energy-efficient learning in dynamic multi-agent systems. 
