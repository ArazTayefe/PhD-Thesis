...
\begin{figure}[H]
	...
	\caption{State and delay estimation error for \(D=\left( 6, 7, 9, 10\right)\) $ms$}
	\label{fig:Error(NormalLow)}
\end{figure}

\begin{figure}[H]
	\centerline{\includegraphics{Figures/UNormalLow.eps}}
	\caption{Control signals for \(D=\left( 6, 7, 9, 10\right)\) $ms$}
...
\begin{figure}[H]
	...
	\caption{State and delay estimation error when delays and their distribution changed.}
